...
$decryptedMerchantName = "Best Electronics";
$decryptedMerchantStatus = "";
$decryptedMerchantUsername = "";
$decryptedMerchantPassword = "";


//
// if(isset($_COOKIE[$cookiemerchantname]) && isset($_COOKIE[$cookiemerchantstatus]) && isset($_COOKIE[$cookiemerchantusername]) && isset($_COOKIE[$cookiemerchantpassword])) {
//
