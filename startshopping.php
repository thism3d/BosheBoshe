...
<html lang="en">
      <head>
          ...
          <title>Start Shopping - BosheBoshe | Online Shopping Market in Bangladesh | Stay Home and Do Shopping</title>


          <?php

              session_start();
              $_SESSION["extraparamsforproduct"] = "";
...
?>
  ...
  <div id="every_product_category" class="clearfix">   <!-- Every product container starts here -->
          ...
          <div id="all_products_container" class="clearfix">    <!-- Products Section Starts Here -->
              ...
              <p id="nagivator_on_products"><a href="index">Home</a> &gt; <a href="startshopping">For You</a></p>
              <h2 id="all_products_container_h2">Start Shopping with Bosheboshe</h2>
              ...
              <div id="products_here" class="clearfix">         <!-- Products Goes Here -->
                ...
                <?php
                  ...
                  $sql = "SELECT productscode, productpicture, productname, minprice, maxprice, offeredprice, besafeless, sellername FROM productsforsell LIMIT 80;";
