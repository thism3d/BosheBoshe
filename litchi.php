...
<html lang="en">
      <head>
          ...
          <title>Lichi of Dinajpur - BosheBoshe | Online Shopping Market in Bangladesh | Stay Home and Do Shopping</title>
...
<?php
        ...
        $eofFoundOrNot = 0;
          ...
          $_SESSION["extraparamsforproduct"] = "productcategories LIKE '%Lichi%' AND";
...
?>
  ...
  <div id="every_product_category" class="clearfix">   <!-- Every product container starts here -->
          ...
          <div id="all_products_container" class="clearfix">    <!-- Products Section Starts Here -->
              ...
              <p id="nagivator_on_products"><a href="index">Home</a> &gt; <a href="litchi">Litchi</a></p>
              <h2 id="all_products_container_h2">Litchi of Dinajpur</h2>
              ...
              <?php
                ...
                echo '
                <div id="extra_images_of_lichi">
                <div class="lichiImageDiv">
                  <img src="lichiimage/IMG_9891.png" alt="Bedena Lichi of Dinajpur">
                </div>
                  <div class="lichiImageDiv">
                    <img src="lichiimage/IMG_9613.png" alt="Bedena Lichi of Dinajpur">
                  </div>
                  <div class="lichiImageDiv">
                    <img src="lichiimage/IMG_9871.png" alt="Bedena Lichi of Dinajpur">
                  </div>
                  <div class="lichiImageDiv">
                    <img src="lichiimage/IMG_9872.png" alt="Bedena Lichi of Dinajpur">
                  </div>
                </div>
                ';
