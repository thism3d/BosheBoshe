    ...
    echo '<div id="cart_div_container" class="clearfix">
        ...
        <div id="main_container">     <!-- Main Container Starts Here -->
          ...
          <div id="first_section" class="clearfix">    <!-- First Section Starts Here -->
            ...
            <div id="right_first_section" class="clearfix">
              <div id="inside_search_final">
                <input onkeyup="return myCustomKeyPress(this.value, event)" type="search" name="mysearch" id="my_real_search_box" placeholder="Type Here For Search" autofocus>
                <button id="real_search_button" onclick="searchbuttonclicked()"><i class="fa fa-search"></i></button>
                <!-- <a href=""><p id="my_hidden_search_box"><i class="fa fa-search"></i> Search Products</p></a> -->
              </div>
            </div>
            ...
            <div id="third_first_section">
              ...
              <a id="non_hidden_thirda" href="member"><p id="non_hidden_thirdp3"><span><i class="fa fa-user"></i></span></p></a>
            </div>
