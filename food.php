...
<html lang="en">
      <head>
          ...
          <title>Food - BosheBoshe | Online Shopping Market in Bangladesh | Stay Home and Do Shopping</title>
...
<?php
        ...
        $eofFoundOrNot = 0;
          ...
          $_SESSION["extraparamsforproduct"] = "productcategories LIKE '%Food%' AND";
...
?>
  ...
  <div id="every_product_category" class="clearfix">   <!-- Every product container starts here -->
          ...
          <div id="all_products_container" class="clearfix">    <!-- Products Section Starts Here -->
              ...
              <p id="nagivator_on_products"><a href="index">Home</a> &gt; <a href="food">Food</a></p>
              <h2 id="all_products_container_h2">Food</h2>
